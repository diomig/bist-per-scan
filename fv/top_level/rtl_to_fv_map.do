...
# Generated on: Mon Jan 08 00:33:55 WET 2024 (Mon Jan 08 00:33:55 UTC 2024)
...
set_log_file fv/top_level/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/top_level -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  sources/top_level.v sources/controller.v sources/inputLFSR.v sources/stateLFSR.v sources/misr.v sources/circuito06_scan_syn.v
elaborate_design -golden -root {top_level} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/top_level/fv_map.v.gz
elaborate_design -revised -root {top_level}
...
#add_name_alias fv/top_level/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/top_level/rtl_to_fv_map.log
}
