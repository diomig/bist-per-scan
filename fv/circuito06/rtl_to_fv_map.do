...
# Generated on: Mon Jan 08 00:33:23 WET 2024 (Mon Jan 08 00:33:23 UTC 2024)
...
set_log_file fv/circuito06/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/circuito06 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  sources/circuito06.v
elaborate_design -golden -root {circuito06} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/circuito06/fv_map.v.gz
elaborate_design -revised -root {circuito06}
...
#add_name_alias fv/circuito06/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/circuito06/rtl_to_fv_map.log
}
